...
def experiment(U, d, beta):
    ...
    results = {"opts": opts, "roros": roros, "lazys": lazys, "agnostics": agnostics, "constThresholds": constThresholds, "minimizers": minimizers, "clip2s": clip2s, 
                "cost_opts": cost_opts, "cost_roros": cost_roros, "cost_lazys": cost_lazys, "cost_agnostics": cost_agnostics, "cost_constThresholds": cost_constThresholds, "cost_minimizers": cost_minimizers, "cost_clip2s": cost_clip2s,}
    with open("dim/dim_results_d{}.pickle".format(d), "wb") as file:
